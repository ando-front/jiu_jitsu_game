...
生成後、以下のサブフォルダを `Source/BJJSimulator/` に作る:
...
[stage2_port_plan_v1.md §3](../../../docs/design/stage2_port_plan_v1.md) の段階に従う:
...
6. 固定ステップ(AGameMode)
7. Blueprint(Character rig, Animation Blueprint, PostProcess Material)
8. Automation Test で Stage 1 の 268 ケースを緑化

**[1]〜[4] はエディタ不要でビルド可** なので、CI で port の退行を検出できる。
